...
- [2020.07.20] First stable release for the phpMussel v3 Front-End.
...
- [2020.08.04]: Addressed a potential compatibility problem with installations where PHP has its output proxied through to a different host. Also slightly improved the aesthetics of the front-end, and changed the logout link to a logout button.
- [2020.10.08]: Added some 'copy to clipboard' buttons to the homepage and statistics page.
- [2020.10.09]: Aesthetic patch + added a new theme.

### v3.1.0

- [2020.10.30]: Redesigned the login pips and refactored some CSS.
- [2020.10.30]: Added the ability to specify a custom assets path to the instantiated FrontEnd object.
...
- [2021.02.05]: The preview text next to the input fields on the configuration page didn't quite align properly; Fixed.
- [2021.02.07]: Added the ability to hide the phpMussel version used.
- [2021.02.20]: Sync common classes package.
...
- [2021.04.27]: Removed the default username/password tip from the front-end login page.
- [2021.05.07]: Very slightly reworked/improved the front-end CSS.
- [2021.06.06]: Reworked checkbox support for the front-end configuration page in preparation for some future configuration directives.

### v3.2.0

#### Bugs fixed.
- [2021.09.09]: The front-end signature information page reported the wrong counts for unidentified or other under the signature vendor or source counts; Fixed.

#### Other changes.
- [2021.06.07]: Since v3, the "repository backup locations" are kind of useless (not linked up with Composer, and only providing metapackage data, rather than all the attached repositories/packages). Removed those links from the front-end home page and v3 documentation accordingly.
- [2021.06.08]: Subtle aesthetic patch.
- [2021.10.30]: Code-style cleanup: Public before private properties, magic before public before private methods.
- [2021.10.30]: Removed a useless method (sendEmail, did nothing, used nowhere).
...
- [2022.01.22]: Dropped Gitter chat in favour of using GitHub Discussions instead.
...
#### Bugs fixed.
- [2022.05.04]: Session cache entries weren't being deleted correctly when logging out; Fixed.
- [2022.05.26]: Instead of "GMT", the "Last modified" header given for front-end assets specified "+0000", which some browsers don't understand properly; Fixed.

#### Other changes.
- [2022.04.26]: Added a JavaScript warning to the front-end login.
- [2022.05.02]: Front-end warnings have been hidden from non-logged in users.
- [2022.05.08]: Restored the "logged in" notice shown for currently logged-in accounts at the front-end accounts page (this feature has long since already existed for v1 and v2, but had been removed at the v3 branch).
- [2022.05.08]: Made the warnings/notices at the front-end accounts page slightly smaller.
- [2022.06.09]: Following symlinks for RecursiveDirectoryIterator instances enabled.
- [2022.06.17]: Slightly improved RTL support.
- [2022.07.17]: Added a warning to the cache data page regarding logging all users out when clearing all cache data.
- [2022.07.21]: Coloured the "delete" option available at various dropdown menus red, to make it stand out a little from the other options.
- [2022.07.23]: Added the ability to reset specific parts of the configuration back to their defaults.
- [2022.07.28]: Added L10N for Malay.
- [2022.09.22]: Added L10N for Ukrainian.
...
- [2022.10.22]: Added L10N for Persian/Farsi.
...
#### Bugs fixed.
- [2022.12.10]: The reset button at the front-end configuration page wasn't resetting the hidden "other" field; Fixed.
- [2023.01.12]: Decimals in the names, choice keys, and labels keys of configuration directives were being coerced by PHP to underscores; Fixed.

#### Other changes.
- [2023.01.06]: Added L10N for Hebrew.

### v3.3.2

#### Bugs fixed.
- [2023.01.19]: Multiple choice configuration directives in radio style weren't being correctly populated from the configuration at the front-end configuration page; Fixed.
...
- [2023.03.08]: Optimised nav icons, pip icons, and related assets.
...
- [2023.12.12]: Split the code for most of the various front-end pages, which the view method was responsible for, into their own distinct files.
- [2023.12.26]: Refactored the page greeting.

### v3.5.1

- [2024.04.12]: Code-style patch.
...
- [2024.06.18]: Slightly refactored some L10N data.
