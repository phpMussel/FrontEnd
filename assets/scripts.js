...
function toggleconfig(e,f){x=document.getElementById(e),y=document.getElementById(f),x.style.display!='none'?(x.style.display='none',y.className='unshownlink s'):(x.style.display='inline',y.className='shownlink s')}
