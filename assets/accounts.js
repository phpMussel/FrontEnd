...
function calculatePasswordEntropy(t){const o=t.length;if(0===o)return '';const n={};for(let r=0;r<o;r++){const o=t.charAt(r);n[o]=(n[o]||0)+1}let r=0;for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t)){const c=n[t]/o;r+=Math.abs(c*Math.log2(c))}let c=o<8?0:o/8-1;t=r+c+(((/[a-z]/.test(t))&&(/[A-Z]/.test(t))&&(/[0-9]/.test(t))&&(/[^A-Za-z0-9]/.test(t)))*3);return t<4?'<span class=\u{22}txtRd\u{22}>{PasswordStrengthLow}</span>':t>6.5?'<span class=\u{22}txtGn\u{22}>{PasswordStrengthHigh}</span>':'<span class=\u{22}txtOe\u{22}>{PasswordStrengthMedium}</span>'}
